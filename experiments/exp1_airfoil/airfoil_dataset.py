...
class AirfoilDataset(Dataset):
    def __init__(self, csv_file, shape_dir, set_type, train_size=0.7, test_size=0.2, random_seed=0):
        ...
        params:
            ...
            shape_dir (string): Directory containing airfoil shape files.
            set_type (string): Dataset type (train, test, or valid).
            train_size (float): Proportion of dataset to be used in training set.
            test_size (float): Proportion of dataset to be used in testing set.
    ...
    def __getitem__(self, idx):    
        ...
        AR=self.airfoil_df['AR'].iloc[idx]
